      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table id="module" class="list">
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              <td class="left"><input type="text" name="carousel_module[<?php echo $module_row; ?>][heading_title]" value="<?php echo $module['heading_title']; ?>" size="50" /></td>
              <td class="left">
                <select name="carousel_module[<?php echo $module_row; ?>][banner_id]">
              ...
              <td class="left">
                <input type="text" name="carousel_module[<?php echo $module_row; ?>][width]" value="<?php echo $module['width']; ?>" size="3" />
              ...
              <td class="left">
                <select name="carousel_module[<?php echo $module_row; ?>][layout_id]">
              ...
              <td class="left">
                <select name="carousel_module[<?php echo $module_row; ?>][position]">
              ...
              <td class="left">
                <select name="carousel_module[<?php echo $module_row; ?>][status]">
...
function addModule() {	
	...
	html += '  <tr>';
  html += '    <td class="left"><input type="text" name="carousel_module[' + module_row + '][heading_title]" value="" size="50" /></td>';
