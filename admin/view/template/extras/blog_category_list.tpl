...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/blog_category.png" alt="" /> <?php echo $heading_title; ?></h1>
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($blog_category['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php echo $blog_category['name']; ?></td>
              <td class="right"><?php echo $blog_category['sort_order']; ?></td>
              <td class="right"><?php foreach ($blog_category['action'] as $action) { ?>
