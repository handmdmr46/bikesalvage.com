      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            ...
            <td><input type="text" name="blog" value="<?php echo $blog; ?>" />
              <input type="hidden" name="blog_id" value="<?php echo $blog_id; ?>" />
              <?php if ($error_blog) { ?>
              <span class="error"><?php echo $error_blog; ?></span>
              <?php } ?></td>
          </tr>
          <tr>
...
$('input[name=\'blog\']').autocomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: 'index.php?route=extras/blog_comment/autocomplete&token=<?php echo $token; ?>&filter_title=' +  encodeURIComponent(request.term),
			dataType: 'json',
	...
	select: function(event, ui) {
		$('input[name=\'blog\']').val(ui.item.label);
		$('input[name=\'blog_id\']').val(ui.item.value);
