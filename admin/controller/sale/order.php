...
class ControllerSaleOrder extends Controller {
	/**
	* Modified: only get orders where products have affiliate_id = 0
	*
	*/
	...
	/**
	* Modified: only gets orders where order_product affiliate_id = 0
	*           - getOrdersByAffiliateId()  
	*           - getTotalOrdersByAffiliateId()
	*/
