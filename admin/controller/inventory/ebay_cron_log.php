...
class ControllerInventoryEbayCronLog extends Controller {
	public function index() {     
		$this->language->load('inventory/ebay_cron_log');
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('inventory/ebay_cron_log', 'token=' . $this->session->data['token'] . $url, 'SSL'),
			'separator' => ' :: '
		);
		...
		$pagination->url = $this->url->link('inventory/ebay_cron_log', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
