...
class ControllerAffiliateSetting extends Controller {
	/**
	* Settings for affiliates:
	* commission
	* ebay developer profile settings
	*
	*/
	private $error = array();
	...
	public function index() {
  	...
  	protected function getList() {
		...
		// language			
		$this->data['heading_title'] = $this->language->get('heading_title_setting');
		...
		$this->template = 'affiliate/setting_list.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
