<?php
class ControllerAffiliateApproval extends Controller {
	/**
  	...
  	protected function getList() {
    	...
    	foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('affiliate/update', 'token=' . $this->session->data['token'] . '&affiliate_id=' . $result['affiliate_id'] . $url, 'SSL')
			);
		...
		// language			
		$this->data['heading_title'] = $this->language->get('heading_title_approval');
		...
		$this->template = 'affiliate/approval_list.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
