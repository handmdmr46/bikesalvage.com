<?php
class ControllerAffiliateImport extends Controller {
	/**
	* View affiliate product imports
	*
	*/
	...
	public function index() {
  	...
  	protected function getList() {
		...
		// language			
		$this->data['heading_title'] = $this->language->get('heading_title_import');
		...
		$this->template = 'affiliate/import_list.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
