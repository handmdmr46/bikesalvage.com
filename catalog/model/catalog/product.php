	...
	*/
	...
	public function getProduct($product_id) {
		...
		if ($query->num_rows) {
			...
			if ($query->row['affiliate_id'] > 0) {
				$shipped_from = $this->getAffiliateAddressString($query->row['affiliate_id']);
		    } else {
		    	$shipped_from = $this->config->get('config_address');
		    }
			return array(
	...
	public function getProducts($data = array()) {
		...
		// get product_data foreach product queried
	...
	public function getAffiliateAddressString($affiliate_id) {
		...
		$string = $query->row['address_1'];
		$string .= ' ' . $query->row['city'];
		$string .= ', ' . $zone->row['name'];
		$string .= ' ' . $query->row['postcode'];
