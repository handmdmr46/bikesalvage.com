<?php
class ModelAffiliateDashboardStockControl extends Model {
	/**
	...
	*/
	...
	public function getLinkedProducts($data= array(), $affiliate_id) {
		$sql = "SELECT    el.product_id,
				...
				WHERE     el.affiliate_id = '" . (int)$affiliate_id . "'";
