...
$_['text_alert_other_sellers']  = '--------------------------------------------------------------------------------' . "\n";  
$_['text_alert_other_sellers']  .= '------ ATTENION: There other seller(s) products are present on this order ------' . "\n";
$_['text_alert_other_sellers']  .= '--------------------------------------------------------------------------------' . "\n\n";
$_['text_additional_products']  = 'Additional Products:' . "\n";
$_['text_master_order']         = "\n\n" . 'Master Order Totals:' . "\n";
?>