...
class ControllerAffiliateDashboard extends Controller {
	public function index() {
		...
		$this->data['text_customer_year']         = $this->language->get('text_customer_year');
		...
		$this->data['text_usps_activate_message'] = sprintf($this->language->get('text_usps_activate_message'), $this->affiliate->getFirstName(), $this->url->link('affiliate/dashboard_setting_shipping', 'token=' . $this->session->data['token'], 'SSL'));
		...
		$this->data['total_customer_year']     = $this->model_affiliate_dashboard_order->getTotalCustomersYearByAffiliateId($affiliate_id);
