...
class ControllerAffiliateDashboardOrder extends Controller {
	...
	public function info() {
		...
		if ($order_info) {
			...
			$this->document->setTitle('Order Info');

			// language
			$this->data['heading_title'] = 'Order Info';
			...
			$this->data['breadcrumbs'][] = array(
				'text'      => 'Order Info',
				'href'      => $this->url->link('affiliate/dashboard_order/info', 'token=' . $this->session->data['token'] . $url, 'SSL'),
				'separator' => ' :: '
			);
			...
			$shipping_total = $this->model_checkout_order->getAffiliateShippingTotal($affiliate_id, $this->request->get['order_id']);
			$sub_total      = $this->model_checkout_order->getAffiliateSubTotal($affiliate_id, $this->request->get['order_id']);
			$total_total    = $this->model_checkout_order->getAffiliateTotalTotal($affiliate_id, $this->request->get['order_id']);
