...
<?php echo $exact_ctr; ?></pre>
<div class="pull-left">
	<div class="wait" style="display: none;"><b>Please wait, returning to checkout.....</b><img src="catalog/view/theme/childtheme/image/loading.gif" alt="" width="20" height="20" /></div>
